...
class ConfigDatabase
{
    ...
    public static function vehicleInput(): array
    {
        ...
        return [
            ...
            'number_of_doors' => self::$instance->optional()->randomDigit(),
            'number_of_seats' => self::$instance->optional()->randomDigit(),
            'fuel_type' => self::$instance->optional()->realTextBetween(6, 10),
            'transmission' => self::$instance->optional()->realTextBetween(6, 10),
            'car_type_group' => self::$instance->optional()->realTextBetween(6, 10),
